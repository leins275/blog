...
draft: false
description: Автор делится опытом настройки AI-агентов через платформу N8N для автоматизации
  публикации контента, включая генерацию постов и отправку их в блог через GitHub
  API.
---
