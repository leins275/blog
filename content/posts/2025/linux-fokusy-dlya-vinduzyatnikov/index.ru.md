...
tags: []
draft: false
description: Опыт использования Linux-инструментов для управления файлами и бэкапами
  в среде Windows с WSL. Автор делится полезными утилитами rdfind и robocopy.
---
