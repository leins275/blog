...
draft: false
description: Автор делится опытом перехода с одного монитора на два — рассказывает
  о преимуществах использования второго экрана для более удобной работы, особенно
  при сочетании корпоративной среды и локального компьютера.
---
