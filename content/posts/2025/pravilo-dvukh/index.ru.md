...
tags: []
draft: false
description: Автор делится подходом к организации хранения важных файлов, предлагая
  использовать 'правило двух' — размещение данных в двух независимых местах без использования
  синхронизации.
---
