...
tags: []
draft: false
description: Автор делится наблюдениями о важности наполненности заметок. Он изменил
  подход от создания коротких, атомарных записей к более содержательным и цельным
  заметкам, чтобы каждая из них имела ценность.
---
