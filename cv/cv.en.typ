...
- Shipped as a FastAPI + Vue service with a public demo at #link("https://eye.its.xyz")[eye.its.xyz]; supervised three bachelor/master theses, registered a database certificate, and presented the work at a U-Net meetup.
...
==== FADM --- Web Application Support _(RUVENTS · Jan 2021 -- Oct 2021)_
...
- Open-source directed-graph data structure with automatic garbage collection, used by the EO virtual machine; #link("https://crates.io/crates/sodg")[published on crates.io] with CI gates on coverage and lint via GitHub Actions.
