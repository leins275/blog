...
- Телефон / WhatsApp: +90 531 601 4154
- LinkedIn: https://linkedin.com/in/leins275
- Сайт: https://leins275.xyz
...
- Выложил web-сервис на FastAPI + Vue с публичным демо на https://eye.its.xyz; руководил тремя бакалаврскими/магистерскими работами, зарегистрировал свидетельство на БД и выступил с докладом про U-Net на митапе.
...
- Портфолио: https://leins275.xyz
- LinkedIn: https://linkedin.com/in/leins275
- XTHON: https://xthon.xyz
- Eye Vessel Demo: https://eye.its.xyz
- Доклад про U-Net: https://youtu.be/unuBcZAFOvY
- Доклад про управление знаниями: https://youtu.be/sdgjbPIgvRQ
